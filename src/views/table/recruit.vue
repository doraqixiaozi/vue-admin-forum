  ...
  <div>
    ...
    <el-form :inline="true">
      ...
      <el-form-item label="任职方式">
        <el-select v-model="searchMap.type" placeholder="请选择">
          <el-option label="全职" value="1"></el-option>
          <el-option label="兼职" value="2"></el-option>
        </el-select>
      </el-form-item>
      <el-form-item label="企业">
        <el-select v-model="searchMap.eid" filterable placeholder="请选择">
          <el-option
      ...
      <el-form-item label="学历要求">
        <el-input v-model="searchMap.education" placeholder="学历要求"></el-input>
      </el-form-item>
      ...
      <el-form-item label="标签">
        <el-select v-model="searchMap.label" placeholder="请选择">
          <el-option
    ...
    <el-table
      ...
      <el-table-column label="任职方式">
        <template slot-scope="scope">
          {{scope.row.type=='1'?'全职':'兼职'}}
        </template>
      </el-table-column>

      <el-table-column prop="address" label="办公地址"></el-table-column>
      <el-table-column prop="ename" label="企业"></el-table-column>
      ...
      <el-table-column prop="content1" label="职位描述" :show-overflow-tooltip="true"></el-table-column>
      <el-table-column prop="content2" label="职位要求" :show-overflow-tooltip="true"></el-table-column>
    ...
    <el-dialog title="编辑" :visible.sync="dialogFormVisible">
      <el-form label-width="80px">
        ...
        <el-form-item label="标签">
          <el-input v-model="pojo.label"></el-input>
        </el-form-item>
        <el-form-item label="职位描述">
          <el-input v-model="pojo.content1"></el-input>
        </el-form-item>
        <el-form-item label="职位要求">
